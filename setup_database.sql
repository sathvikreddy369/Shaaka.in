-- Step 1: Add columns to crops table if they don't exist
ALTER TABLE crops 
...
-- Step 4: Insert dummy farmers (password: password123)
...
-- Step 7: Insert dummy employees (password: password123)
...
-- Step 8: Insert dummy cooked foods
...
-- Step 10: Insert dummy reviews (only if crops exist)
...
-- Step 11: Update crop ratings based on reviews
UPDATE crops c
