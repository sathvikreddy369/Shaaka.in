...
if __name__ == "__main__":
    print("=" * 60)
    print("Setting up Shaaka Database")
    print("=" * 60)
    ...
    print("  • tom@example.com")
    print("  • emma@example.com")
    print("\nVendors/Sellers (use phone number):")
    ...
    print("\nAdmins:")
    print("  • admin@shaaka.com")
    print("  • superadmin@shaaka.com")
    print("=" * 60)
    print("\n📊 Dummy Data Summary:")
    print("-" * 60)
    print("  • 8 Customers")
    print("  • 5 Vendors (selling fresh produce)")
    print("  • 15 Products (vegetables, fruits, grains)")
    print("  • 15+ Product Reviews")
    print("  • 8 Recipes")
    print("  • 4 Homemakers")
    print("  • 12 Homemade Food Items")
    print("=" * 60)
